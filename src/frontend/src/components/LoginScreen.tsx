...
export default function LoginScreen() {
  const { login, loginStatus, isLoggingIn, isInitializing } =
    useInternetIdentity();
  ...
  return (
    <div className="relative min-h-screen flex items-center justify-center overflow-hidden bg-background">
      ...
      <div
        ...
        style={{
          backgroundImage:
            "url('/assets/generated/trading-bg.dim_1920x1080.png')",
        }}
      />
      ...
      <div
        ...
        style={{
          backgroundImage:
            "linear-gradient(oklch(0.7 0.15 145) 1px, transparent 1px), linear-gradient(90deg, oklch(0.7 0.15 145) 1px, transparent 1px)",
        ...
        <div className="bg-card/80 backdrop-blur-sm border border-border rounded-2xl p-8 shadow-2xl">
          ...
          <div className="flex flex-col items-center mb-8">
            ...
            <h1 className="text-2xl font-bold text-foreground tracking-tight">
              Operator Trading Journal
            </h1>
            <p className="text-sm text-muted-foreground mt-1">
              Professional intraday trade tracking
            </p>
          </div>
