...
export default function StrategyAutocomplete({
  ...
  const suggestions = useCallback((): string[] => {
    ...
    return strategies.filter(
      (s) => s.toLowerCase().includes(q) || abbreviationMatch(q, s),
    );
  }, [value, strategies]);
  ...
  // biome-ignore lint/correctness/useExhaustiveDependencies: value is a prop that drives suggestion filtering
  useEffect(() => {
