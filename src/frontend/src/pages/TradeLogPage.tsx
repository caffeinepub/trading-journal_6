...
export default function TradeLogPage() {
  ...
  const tradeMarketTypes = useMemo(() => {
    ...
    for (const t of trades) {
      if (t.marketType) set.add(String(t.marketType));
    }
  ...
  const filtered = useMemo(() => {
    return trades.filter((t) => {
      ...
      const matchType =
        typeFilter === "All" || String(t.marketType) === typeFilter;
      const matchStrategy =
        !strategyFilter.trim() ||
        strategyStr.toLowerCase().includes(strategyFilter.toLowerCase().trim());
      const matchMistake =
        mistakeFilter === "All" || t.mistakeType === mistakeFilter;
      return (
        matchSearch &&
        matchDirection &&
        matchType &&
      ...
      <div className="glass-card rounded-2xl p-4 space-y-3">
        ...
        <div className="flex flex-wrap gap-2 items-center">
          ...
          >
            ...
            <option value="Buy" className="bg-card">
              Buy / Long
            </option>
            <option value="Sell" className="bg-card">
              Sell / Short
            </option>
          </select>
      ...
      {isLoading ? (
        ...
        <div className="space-y-3">
          {filtered.map((trade) => {
            ...
            const strategyStr =
              typeof trade.strategy === "string" ? trade.strategy : "";
              ...
              >
                ...
                >
                  ...
                  <div className="text-right shrink-0">
                    ...
                    <p className="text-xs text-muted-foreground">
                      {formatMarketType(String(trade.marketType))}
                    </p>
                  </div>
