import { BookOpen, Info, Loader2, Settings, Trash2 } from "lucide-react";
import React from "react";
import { toast } from "sonner";
import { useDeleteStrategy, useGetStrategies } from "../hooks/useQueries";

export default function SettingsPage() {
  const { data: strategiesRaw = [], isLoading: strategiesLoading } =
    useGetStrategies();
    ...
    <div className="max-w-2xl mx-auto space-y-6">
      ...
      <div className="glass-card rounded-2xl p-5 space-y-4">
        ...
        <div className="space-y-2 text-sm text-muted-foreground">
          <p>
            ...
            — A professional trading journal built on the Internet Computer.
          </p>
      ...
      <div className="glass-card rounded-2xl p-5">
        ...
        <p className="text-sm text-muted-foreground">
          The application uses a fixed dark navy theme optimized for trading
          environments.
        </p>
      </div>
      ...
      <div className="glass-card rounded-2xl p-5 space-y-4">
        ...
        <p className="text-xs text-muted-foreground">
          Strategies are automatically saved when you log trades. Delete unused
          ones here.
        </p>
        ...
        {strategiesLoading ? (
          ...
          <div className="rounded-xl bg-white/3 border border-white/8 px-4 py-6 text-center">
            <p className="text-sm text-muted-foreground">
              No saved strategies yet. Strategies are automatically saved when
              you log trades.
            </p>
          </div>
        ) : (
